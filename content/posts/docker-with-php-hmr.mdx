---
title: Containerizing a Laravel App with Node.js, Vite, and Hot Module Reloading
...
```Dockerfile title="docker/php/Dockerfile"
...
Inside `vite.config.js`, make sure your Vite dev server is accessible from Docker and uses the correct HMR settings:
